...
import { GuidedExercisesPage } from '@/pages/GuidedExercisesPage'
import { BreathingTechniquesPage } from '@/pages/BreathingTechniquesPage'
import { WellbeingTestsPage } from '@/pages/WellbeingTestsPage'
import './i18n/config'
        ...
        <AuthProvider>
          <MainLayout>
            <Routes>
              ...
              <Route path="/publicaciones" element={<ProtectedRoute><PublicationsPage /></ProtectedRoute>} />
              <Route path="/publicaciones/usuario/:id" element={<ProtectedRoute><UserPublicationsPage /></ProtectedRoute>} />
              <Route path="/chat" element={<ProtectedRoute><ChatPage /></ProtectedRoute>} />
              <Route path="/actividades/ejercicios" element={<ProtectedRoute><GuidedExercisesPage /></ProtectedRoute>} />
              <Route path="/actividades/relajacion" element={<ProtectedRoute><BreathingTechniquesPage /></ProtectedRoute>} />
              <Route path="/actividades/tests" element={<ProtectedRoute><WellbeingTestsPage /></ProtectedRoute>} />
