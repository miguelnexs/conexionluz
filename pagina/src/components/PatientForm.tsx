    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-6">
        <div className="flex items-start">
          ...
          <div className="ml-3">
            <h4 className="text-sm font-medium text-blue-800">Información de la cita</h4>
            <p className="text-sm text-blue-700 mt-1">
              Estos datos se guardan para gestionar tu cita. Si tienes una cuenta, la cita quedará vinculada a tu perfil; si no, se registrará como persona anónima con tus datos de contacto.
            </p>
          </div>
        </div>
      </div>
