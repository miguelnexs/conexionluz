    ...
    return (
      <div className="space-y-4 animate-fade-in">
        <div className="text-center">
          <h3 className="text-lg font-semibold text-gray-800 mb-2">No atendemos domingos</h3>
          <p className="text-gray-600">Selecciona otra fecha para ver horarios disponibles.</p>
        </div>
      </div>
    );
  }
