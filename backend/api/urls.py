...
urlpatterns = [
    ...
    path("courses/<int:course_id>/enrollments/", views.course_enrollments),
    path("courses/<int:course_id>/enrollments/<int:enrollment_id>/", views.course_enrollment_detail),
    ...
    path("portal/me/cover/", views.portal_upload_cover_picture),
    path("portal/cover-picture/", views.portal_upload_cover_picture),
    ...
    path("portal/courses/<slug:slug>/enroll/", views.portal_course_enroll),
    ...
    path("portal/lumi/wallet/", views.portal_lumi_wallet),
    path("portal/lumi/claim-daily/", views.portal_lumi_claim_daily),
    path("portal/lumi/buy/", views.portal_lumi_buy),
    path("portal/lumi/spend/", views.portal_lumi_spend),
    ...
    path("public/stories/<str:story_id>/", views.public_story_detail),
    path("public/stories/<str:story_id>/like/", views.public_story_like),
    path("public/stories/<str:story_id>/comment/", views.public_story_comment),
    ...
    path("payments/mercadopago/verify/", views.mercadopago_verify_and_credit_lumi),
    path("public/settings/", views.public_site_settings),
    # Community posts (feed)
    path("public/community-posts/", views.public_community_posts),
    path("public/community-posts/<int:post_id>/view/", views.community_post_view),
    ...
    path("portal/community-posts/<int:post_id>/view/", views.community_post_view),
    path("portal/community-posts/<int:post_id>/like/", views.portal_community_post_like),
    path("portal/community-posts/<int:post_id>/share/", views.portal_community_post_share),
    ...
    path("portal/community-posts/comments/<int:comment_id>/reply/", views.portal_community_post_comment_reply),
    path("portal/community-posts/comments/<int:comment_id>/like/", views.portal_community_post_comment_like),
    # Admin moderation
    ...
    path("public/send-wellbeing-report/", views.send_wellbeing_report),
    # Adaptive Wisdom Engine (AWE)
    path("portal/awe/daily/", views.portal_awe_daily),
    path("portal/awe/profile/", views.portal_awe_profile),
    path("portal/awe/collection/", views.portal_awe_collection),
    path("portal/awe/mark-read/", views.portal_awe_mark_read),
]
